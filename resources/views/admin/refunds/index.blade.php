        ...
        <x-table :headers="['Order', 'Vendor', 'Requested by', 'Amount', 'Reason', 'Status', '']" id="refunds-table">
            @forelse ($refunds as $refund)
                <tr class="border-b border-gray-50 hover:bg-gray-50 transition-colors">
                    ...
                    <td class="px-4 py-3 text-gray-500">{{ $refund->vendorOrder->vendor->name }}</td>
            ...
            @empty
                <tr>
                    <td colspan="7" class="px-4 py-10 text-center text-gray-400 text-sm">No refund requests yet.</td>
                </tr>
            @endforelse
        </x-table>

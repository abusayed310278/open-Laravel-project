...
@section('content')
    ...
    <div class="flex items-center justify-between mb-4">
        <x-breadcrumb :items="['Products' => route($routePrefix.'products.index'), $product->title => null]" class="mb-0" />
    ...
    <form method="POST" action="{{ route($routePrefix.'products.update', $product) }}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
